...
public class SignUpPanel extends JPanel {
    ...
    public SignUpPanel(AccessFrame frame) {
        ...
        JLabel titleLabel = createGamingLabel("GAME SIGN UP", 36);
        ...
        JPanel passwordPanel = createGamingInputPanel("ENTER EMAIL", emailField = createGamingTextField());
